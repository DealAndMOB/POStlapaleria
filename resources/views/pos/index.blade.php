...
@section('content')
    <div class="pos-container">
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="action-buttons">
                            ...
                            <!-- Botón de impresión (inicialmente oculto) -->
                            <button id="printTicket" class="btn-main process print-ticket"
                                style="display: none; background: linear-gradient(135deg, #10B981 0%, #059669 100%);">
                                <i class="material-icons-round">print</i>
                                Imprimir Ticket
                            </button>

                            <button id="showExternalProductModal" class="btn-main process"
            ...
            <div class="modal fade" id="externalProductModal" data-bs-backdrop="static" tabindex="-1"
                aria-labelledby="externalProductModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="external_product_price" class="form-control" min="0"
                                    step="0.01" required>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (showExternalProductModalButton) {
                showExternalProductModalButton.addEventListener('click', showExternalProductModal);
            }

            if (addExternalProductButton) {
                addExternalProductButton.addEventListener('click', addExternalProduct);
            }

            // También agregar el evento para cerrar el modal con Escape
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Escape' && externalProductModal._isShown) {
...
function addExternalProduct() {
    ...
    const externalProduct = {
        ...
        price: price,
        is_external: true,
        stock: 999, // Alto número para productos externos
        quantity: 1
    };
    ...
    showAlert('Producto externo agregado al carrito', 'success');
            ...
            function processingSale() {
                ...
                .then(data => {
                    ...
                    if (printButton) {
                        ...
                        printButton.setAttribute('data-sale-id', data.sale.id);
                        printButton.onclick = () => printTicket(data.sale.id);
                    }
            ...
            function printTicket(saleId) {
                ...
                window.open(`/pos/print-ticket/${saleId}`, '_blank');
            ...
            // ... (resto del código existente, incluyendo las funciones de productos externos) ...
   ...
   if (sessionStorage.getItem('currentSale')) {
    ...
    document.head.insertAdjacentHTML('beforeend', `
        <style>
            ...
            .btn-main.print-ticket {
                display: none;
                background: linear-gradient(135deg, #10B981 0%, #059669 100%);
                margin-top: 1rem;
            }
            .btn-main.print-ticket:hover {
                background: linear-gradient(135deg, #059669 0%, #047857 100%);
                transform: translateY(-2px);
                box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);
            }
